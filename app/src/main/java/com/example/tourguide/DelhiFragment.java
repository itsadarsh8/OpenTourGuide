...
public class DelhiFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        arrayList.add(new Data(getResources().getString(R.string.delhi_place_1), getResources().getString(R.string.delhi_detail_1)));
        arrayList.add(new Data(getResources().getString(R.string.delhi_place_2), getResources().getString(R.string.delhi_detail_2)));
        arrayList.add(new Data(getResources().getString(R.string.delhi_place_3), getResources().getString(R.string.delhi_detail_3)));
